...
Pairwise document cosine similarity (mean 0.52, range 0.06--0.94) and UMAP dimensionality reduction \cite{mcinnes2018umap} of clinical content embeddings (all-mpnet-base-v2 \cite{reimers2019sentence}) demonstrate broad semantic distribution across the embedding space---evidence against mode collapse typical of naïve LLM generation.

\begin{figure}[ht]
    \centering
    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{semantic_diversity_clean.png}
    ...
    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{semantic_diversity_styled.png}
        \caption{With persona writing styling applied}
